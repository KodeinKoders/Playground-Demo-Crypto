...
internal class Sha256 : Digest {
    ...
    override fun doFinal(out: ByteArray, outOffset: Int) {
        finish()
        writeInt32BE(H1, out, outOffset)
        writeInt32BE(H2, out, outOffset + 4)
        writeInt32BE(H3, out, outOffset + 8)
        writeInt32BE(H4, out, outOffset + 12)
        writeInt32BE(H5, out, outOffset + 16)
        writeInt32BE(H6, out, outOffset + 20)
        writeInt32BE(H7, out, outOffset + 24)
        writeInt32BE(H8, out, outOffset + 28)
        reset()
    }
    ...
    private companion object {
        ...
        fun Ch(x: Int, y: Int, z: Int): Int {
            return x and y xor (x.inv() and z)
        }

        fun Maj(x: Int, y: Int, z: Int): Int {
